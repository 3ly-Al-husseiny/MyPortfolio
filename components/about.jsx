      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-gray-300 mb-8 text-lg leading-relaxed text-center">
            I Can Build your project with responsive UI UX with high performance and strong security.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10 max-w-xl mx-auto">
            ...
            <div className="flex items-center gap-3 bg-gray-800 p-4 rounded-lg w-max">
              ...
              <span className="text-gray-300">ali.ahmed.software.engineer@gmail.com</span>
            </div>
          </div>

          <div className="text-center">
            <Link
              href="/Ali El-husseiny Resume Updated version.pdf"
              target="_blank"
