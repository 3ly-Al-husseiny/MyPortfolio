      ...
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="text-xl font-bold mb-4 inline-block">
              <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">
                AE<span className="text-white">Portfolio</span>
              </span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md">
              Full Stack Web Developer specializing in Angular and ASP.NET, creating 
              high-performance applications with responsive UI/UX and robust security.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Ali Ahmed El-husseiny. All rights reserved.
          </p>
